function Top (rt) {
  ...
  this.gensym69 = ($env) => {
    ...
    if (_raw_4) {
      ...
      const _val_35 = $env.gensym129.val;
      const _vlev_36 = $env.gensym129.lev;
      const _tlev_37 = $env.gensym129.tlev;
      let _raw_39 = _T.pc;
      let _raw_40 = _T.pc;
      if (! _STACK[ _SP + -6] ) {
  ...
  this.gensym69.serialized = "";
  ...
  this.client30 = ($env) => {
    ...
    const gensym126$$$const = "peter"
    const gensym127$$$const = "Peter"
    const gensym128$$$const = 2002
    const gensym129$$$const = false
    const gensym130$$$const = "chemistry"
    const gensym131$$$const = "parkour"
  ...
  this.client30.serialized = "";
  ...
  this.myAgent23 = ($env) => {
    ...
    const _raw_11 = rt.mkTuple([gensym47, gensym56]);
    _T.r0_val = _raw_11;
    _T.r0_lev = _pc_init;
    _T.r0_tlev = _pc_init;
    return _T.returnImmediate ();
  ...
  this.myAgent23.serialized = "";
  ...
  this.$$$gensym69$$$kont4 = () => {
    ...
    if (_r0_val_246) {
      ...
      if (_raw_76) {
        ...
        const _val_107 = $env.gensym129.val;
        const _vlev_108 = $env.gensym129.lev;
        const _tlev_109 = $env.gensym129.tlev;
        let _raw_111 = _T.pc;
        let _raw_112 = _T.pc;
        if (! _STACK[ _SP + -6] ) {
  ...
  this.$$$client30$$$kont7 = () => {
    ...
    $$$env6.gensym129 = gensym129;
    $$$env6.gensym138 = gensym138;
    $$$env6.gensym137 = gensym137;
    $$$env6.printString4 = $env.printString4;
    $$$env6.print2 = $env.print2;
    $$$env6.__dataLevel =  rt.join (gensym129.dataLevel,gensym138.dataLevel,gensym137.dataLevel,$env.printString4.dataLevel,$env.print2.dataLevel);
